...
const getAllJobs = (req, res) => {
    db.any('SELECT * FROM jobs order by id desc')
...
const updateJob = (req, res) => { 
    db.one('Update jobs set name=${name},price=${price},description=${description},time_spent=${time_spent},status=${status},priorty_level=${priorty_level},due_date=${due_date},received_payment=${received_payment},completion_date=${completion_date} where id = ${id} Returning * ', req.body)
